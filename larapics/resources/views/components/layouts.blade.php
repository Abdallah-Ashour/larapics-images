        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                {{-- <ul class="navbar-nav me-auto"> --}}
                  {{-- <li class="nav-item"><a href="{{ route('image.index') }}" class="nav-link {{ request()->is('account/image*') ? 'active' : '' }}">Images</a></li>
                  ...
                  <li class="nav-item"><a href="#" class="nav-link {{ request()->is('account/favorites*') ? 'active' : ''   }}">Favorites</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('settings.edit') }}">Settings
                                </a>
