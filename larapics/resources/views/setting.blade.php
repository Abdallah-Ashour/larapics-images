                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            {{-- <img src="{{ asset('storage/users/user-default.png') }}" width="150" alt=""> --}}
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="user[bio]" id="biod" rows="3" class="form-control @error('user.bio') is-invalid @enderror"
                                placeholder="In a few words, tell us about yourself">{{ old('user.bio', $user->about_me) }}</textarea>
                                @error('user.bio')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-md-6">
                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="social[instagram]" id="twitter" class="form-control @error('social.instagram') is-invalid @enderror"
                                placeholder="https://www.instagram.com/..."
                                value="{{ old('social.twitter', $user->social->instagram) }}">
